#!/bin/bash
#
# build-hexa.sh: Build scripts for All devices.
# Copyright (C) 2017 The Hexa-Project, KangDroid
#
...
. $ANDROID_BUILD_TOP/vendor/hexa/tools/colors

usage() {
    echo -e "${bldblu}Usage:${bldcya}"
    echo -e "  build-hexa.sh [options] device"
    echo ""
